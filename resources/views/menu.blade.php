                        ...
                        <div class="col-xs-12 col-md-12 col-lg-12">
                            ...
                            <div class="hexagon-menu clear">
                                ...
                                <div class="hexagon-item">
                                    ...
                                    <a class="hex-content" href="/pegawai">
                                        <span class="hex-content-inner">
                                            <span class="icon">
                                                <svg viewBox="0 0 100 100" height="36" width="36" xmlns="http://www.w3.org/2000/svg" style="display:inline-block;vertical-align:middle;position:static;transform:none;z-index:auto;left:auto;top:auto;">
                                                    <circle cx="50" cy="32" r="20" fill="#ffffff"/>
                                                    <ellipse cx="50" cy="82" rx="32" ry="22" fill="#ffffff"/>
                                                </svg>
                                            </span>
                                            <span class="title">Pertemuan 11</span>
                                        </span>
                                        <svg viewBox="0 0 173.20508075688772 200" height="200" width="174"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
